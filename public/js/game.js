...
function preload() 
{
    ...
    icon = {
        redo: loadImage('/public/images/redo.png'), 
        star: loadImage('/public/images/star.png'), 
        starEmpty: loadImage('/public/images/starEmpty.png'), 
        delete: loadImage('/public/images/delete.png'), 
        circle: loadImage('/public/images/circle.png'), 
        back: loadImage('/public/images/back.png'), 
        edit: loadImage('/public/images/edit.png'), 
        help: loadImage('/public/images/help.png'), 
        lock: loadImage('/public/images/lock.png'), 
        play: loadImage('/public/images/play.png'),
        portal1: loadImage('/public/images/wormhole (2).png'), 
        portal2: loadImage('/public/images/wormhole (2).png'),
    };

    // these are all the images that the tracks will use split into the "play" and "build" versions of the tracks
    trackImages = [ 
        {play: loadImage('/public/images/tracks/lv1.png'), build: loadImage('/public/images/tracks/lv1build.png')},
        {play: loadImage('/public/images/tracks/lv2.png'), build: loadImage('/public/images/tracks/lv2build.png')},
        {play: loadImage('/public/images/tracks/lv3.png'), build: loadImage('/public/images/tracks/lv3build.png')},
        {play: loadImage('/public/images/tracks/lv4.png'), build: loadImage('/public/images/tracks/lv4build.png')},
        {play: loadImage('/public/images/tracks/lv5.png'), build: loadImage('/public/images/tracks/lv5build.png')},
        
        {play: loadImage('/public/images/tracks/lv7.png'), build: loadImage('/public/images/tracks/lv7build.png')},
        {play: loadImage('/public/images/tracks/lv8.png'), build: loadImage('/public/images/tracks/lv8build.png')},
        {play: loadImage('/public/images/tracks/lv9.png'), build: loadImage('/public/images/tracks/lv9build.png')},
        {play: loadImage('/public/images/tracks/lv10.png'), build: loadImage('/public/images/tracks/lv10build.png')},
        {play: loadImage('/public/images/tracks/lv11.png'), build: loadImage('/public/images/tracks/lv11build.png')},
        
        {play: loadImage('/public/images/tracks/lv6.png'), build: loadImage('/public/images/tracks/lv6build.png')},
        
        {play: loadImage('/public/images/tracks/lv3.png'),  build: loadImage('/public/images/tracks/lv3build.png')},
        {play: loadImage('/public/images/tracks/lv13.png'), build: loadImage('/public/images/tracks/lv13build.png')},
        {play: loadImage('/public/images/tracks/lv14.png'), build: loadImage('/public/images/tracks/lv14build.png')},
        {play: loadImage('/public/images/tracks/lv15.png'), build: loadImage('/public/images/tracks/lv15build.png')},

    ]

    // these are all the images that are used in popups 
    popUpImage = {
        portal: loadImage('/public/images/popups/popup (1).png'), 
        toggle: loadImage('/public/images/popups/toggle.png'), 
        multipleTestCharges: loadImage('/public/images/popups/popup (2).png'), 
        gameMode: loadImage('/public/images/popups/popup (3).png'), 
        slider: loadImage('/public/images/popups/popup (4).png'), 
        eField: loadImage('/public/images/popups/popup (5).png'), 
        track: loadImage('/public/images/popups/popup (6).png'), 
        negative: loadImage('/public/images/popups/popup (7).png'), 
    ...
    sounds = {
        click: loadSound('/public/sounds/click (1).mp3'),
        lose: loadSound('/public/sounds/hit.mp3'),
        collect: loadSound('/public/sounds/collect.mp3'),
        victory: loadSound('/public/sounds/victory.mp3'),
        portal: loadSound('/public/sounds/portal.mp3'),
        // click: loadSound('/public/sounds/clickv2.mp3'),
        // lose: loadSound('/public/sounds/failv2.mp3'),
        // collect: loadSound('/public/sounds/starv2.mp3'),
        //victory: loadSound('/public/sounds/successv2.mp3'),
        popup: loadSound('/public/sounds/popupv2.mp3'),
        };
...
async function sendScore(data)
{
    ...
    let sendDataLink = `http://localhost:8080/sendData?_id=${data.userID}&time=${data.time}&timestamp=${getDate()}&score=${data.score}&stars_collected=${data.stars}&track=${data.level}`
    
    // console.log(sendDataLink);
...
async function updateLeaderBoard()
{
    ...
    let leaderboardLink = 'http://localhost:8080/leaderboardData/'
    let response = await fetch(leaderboardLink);
    let responseJSON = await response.text()

    // console.log(responseJSON);
    currentLeaderboard = JSON.parse(responseJSON);
